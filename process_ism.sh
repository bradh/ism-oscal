...
# apparently they're better at infosec than spelling...
ZIP_FILE_NAME="Information Secuirty Manual (${FILE_DATE_PART}).zip"
...
java -jar ozcal/xml2oscal/target/xml2oscal-1.0-SNAPSHOT-jar-with-dependencies.jar \
    "$WORK_DIR/List of Security Controls ($FILE_DATE_PART).xml" \
